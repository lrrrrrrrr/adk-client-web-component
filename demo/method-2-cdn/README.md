...
1. **Pin to specific version** for stability:
   ...
   **Note:** Version 0.0.4 is the latest published version with Shadow DOM and embedded styles.
...
- **No styles showing**: Ensure you're using version 0.0.4 or later which includes embedded styles in Shadow DOM.
