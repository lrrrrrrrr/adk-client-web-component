...
1. **Pin to specific version** for stability:
   ```html
   <script type="module">
     import 'https://unpkg.com/adk-client-web-component@1.0.4/dist/adk-client-standalone.js';
   </script>
   ```
   
   **Note:** Version 1.0.4 is the latest published version with Shadow DOM, embedded styles, enhanced CORS support, and full customization features.
...
- **No styles showing**: Ensure you're using version 1.0.4 or later which includes embedded styles in Shadow DOM.
